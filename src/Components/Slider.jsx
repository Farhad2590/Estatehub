    ...
    return (
        ...
        >
            <SwiperSlide className="relative">
                ...
                <div className="animate__animated animate__fadeInDownBig  absolute inset-0 flex flex-col justify-center items-center text-center bg-black bg-opacity-20 rounded-lg">
